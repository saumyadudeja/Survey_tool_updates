import pandas as pd
df = pd.read_excel(r'C:\Users\dudej\Desktop\MasterThesis\card-images\Copy of cards.xlsx', sheet_name = 'Sheet1', header=None)
max_r = len(df)
...
for j in range(3, max_r):
    ...
    img.save(r'C:\Users\dudej\Desktop\MasterThesis\card-images\option_A_'+str(j-3)+'.png')
    text=''
    x=x+count_a
    y=y+count_a
x=0
...
for j in range(3, max_r):
    ...
    img.save(r'C:\Users\dudej\Desktop\MasterThesis\card-images\option_B_'+str(j-3)+'.png')
    text=''
    x=x+count_b
    y=y+count_b
x=0
...
for j in range(3, max_r):
    ...
    img.save(r'C:\Users\dudej\Desktop\MasterThesis\card-images\option_C_'+str(j-3)+'.png')
    text=''
    x=x+count_c
    y=y+count_c